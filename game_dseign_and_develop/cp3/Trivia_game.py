...
def print_text(font, x, y, text, color=(255, 255, 255), shadow=True):
    if shadow:
        imageText = font.render(text, True, (0, 0, 0))
        screen.blit(imageText, (x - 2, y - 2))
...
class Trivia(object):
    ...
    def show_question(self):
        if self.flag:
            ...
            print_text(font2, 530, 5, str(self.score), purple)
            ...
            self.current = -6
            print_text(font1, 0, 0, "Press Enter to answer those question again ")
            print_text(font1, 0, 30, "or Escape to quit")
