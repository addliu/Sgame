...
class Tank(MySprite):
    def __init__(self, tank_file=r"D:\9806-MorePython\resources\code\chap12\tank.png",\
                        turret_file=r"D:\9806-MorePython\resources\code\chap12\turret.png"):
    ...
    def draw(self, surface):
        ...
        surface.blit(self.scratch, (self.X - center.y, self.Y - center.y))
        # draw the turret
...
class EnemyTank(Tank):
    def __init__(self, tank_file=r"D:\9806-MorePython\resources\code\chap12\enemy_tank.png",\
                    turret_file=r"D:\9806-MorePython\resources\code\chap12\enemy_turret.png"):
...
def game_init():
    global crosshair, crosshair_group, screen, backbuffer, font, timer, player_group,player,\
            enemy_tank, bullets
    pygame.init()
    ...
    # load mouse cursor
    crosshair = MySprite()
    crosshair.load(r"D:\9806-MorePython\resources\code\chap12\crosshair.png")
...
def audio_init():
    ...
    # load sound file
    shoot_sound = pygame.mixer.Sound(r"D:\9806-MorePython\resources\code\chap12\shoot.wav")
    boom_sound = pygame.mixer.Sound(r"D:\9806-MorePython\resources\code\chap12\boom.wav")
...
while True:
    ...
    # fire cannon!
    if keys[pygame.K_SPACE] or mouse_up > 0:
    ...
    angle = target_angle(player.turret.X, player.turret.Y, crosshair.X +\
                         crosshair.frame_width/2, crosshair.Y + crosshair.frame_height/2)
