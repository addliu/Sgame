...
class Terrain(object):
    ...
    def generate(self):
        ...
        # first point
        last_x = 0
        last_height = (self.min_height + self.max_height) / 2
...
def audio_init():
    ...
    pygame.mixer.init()
    shoot_sound = pygame.mixer.Sound(r"D:\9806-MorePython\resources\code\chap13\shoot.wav")
    boom_sound = pygame.mixer.Sound(r"D:\9806-MorePython\resources\code\chap13\boom.wav")
...
# this function draw a cannon at the specified position
...
while True:
    ...
    if keys[pygame.K_ESCAPE]:
        ...
        if player_cannon_power >= 0:
            player_cannon_angle -= 0.1
    ...
    if not game_over:
        ...
        if computer_firing:
            ...
            computer_shell_position.y += computer_shell_position.y
        ...
        if not game_over:
            ...
            print_text(font, 0, 580, "CURSOR: " + str(Point(mouse_x, mouse_y)) +\
                    ", GRID_POINT: " + str(grid_point) + ", HEIGHT: " + str(terrain.get_height(mouse_x)))
        else:
