...
def audio_init():
    ...
    pygame.mixer.init()
    # load sound file
    new_oil = pygame.mixer.Sound(r"D:\9806-MorePython\resources\code\chap10\new_oil.wav")
    clean_oil = pygame.mixer.Sound(r"D:\9806-MorePython\resources\code\chap10\clean_oil.wav")
